...
- Colab Pro หรือ Pay As You Go [Link Colab Pro](https://colab.research.google.com/signup?utm_source=resource_tab&utm_medium=link&utm_campaign=want_more_resources)
...
- การตั้งค่าของส่วนนี้มี options ดังต่อไปนี้
  ...
  - ช่องกรอก DOWNLOAD_LIST_URL จะให้กรอก link ที่ได้รวมการ download model ต่างๆ จาก CivitAI หรือ Huggingface เอาไว้ ซึ่งหา link ได้จาก [SD Download List Website](https://vjump-sd-download-list.vjumpkung.dynv6.net/download_list/)
  - CivitAI API Keys กรอก code จุดนี้ (ไม่ใช่รหัสผ่าน civitai account) เพื่อปลดล็อคการ download model ในเว็บ civitai ที่ต้องมีการ Login เพื่อทำการ download
...
- (ไม่บังคับ) CivitAI API Keys กรอก code จุดนี้ (ไม่ใช่รหัสผ่าน civitai account) เพื่อปลดล็อคการ download model ในเว็บ civitai ที่ต้องมีการ Login เพื่อทำการ download
  - [วิธีการขอ CivitAI API Keys](/others/civit)
- หากไม่ได้ใส่ CivitAI API Keys จะไม่สามารถ Download บาง Model ได้เนื่องจากต้อง login จะมี output แบบนี้ 

```
Cannot Download https://civitai.com/api/download/models/540977
```
...
- เมื่อทำการ RUN แล้วจะมี URL พร้อมรหัสผ่าน/ipในการเข้าหน้า ComfyUI

![](/comfy_sec_4_1.png)

- นำ รหัสผ่าน/ip มากรอกที่ช่องนี่้แล้วกด **Click to Submit** ก็จะสามารถเข้าหน้าต่าง ComfyUI
